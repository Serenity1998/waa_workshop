...
class SalonRepository {
  ...
  Future<dynamic> getSalonsById(List<String> categoryIds) async {
    return await _laravelApiClient.getSalonsById(categoryIds);
  }
  ...
  Future<List<Salon>> getNearSalons(
      LatLng latLng, LatLng areaLatLng, String search) {
    return _laravelApiClient.getNearSalons(latLng, areaLatLng, search);
  }
  ...
  Future<List<SalonUser>> getSalonEmployees(String salonId) {
    return _laravelApiClient.getSalonUsers(salonId);
  }
  ...
  Future<List> getAvailabilityHours(
      String eProviderId, DateTime date, String employeeId) {
    return _laravelApiClient.getAvailabilityHours(
        eProviderId, date, employeeId);
  }
}
