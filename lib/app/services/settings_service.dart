...
class SettingsService extends GetxService {
  ...
  ThemeData getLightTheme() {
    ...
    return ThemeData(
      ...
      appBarTheme: AppBarTheme(
          elevation: 0,
          centerTitle: false,
          titleTextStyle: Get.textTheme.titleLarge?.merge(
      ...
      colorScheme: ColorScheme.light(
        primary: Ui.parseColor("#7210FF"),
        secondary: Ui.parseColor("#7210FF"),
      ),
      textTheme: GoogleFonts.getTextTheme(
        _getLocale()!.startsWith('ar') ? 'Roboto' : 'Roboto',
        TextTheme(
  ...
  ThemeData getWebLightTheme() {
    ...
    return ThemeData(
        ...
        textTheme: GoogleFonts.getTextTheme(
          _getLocale().toString().startsWith('ar') ? 'Roboto' : 'Roboto',
          TextTheme(
            titleLarge: TextStyle(
              fontSize: 16.0,
              fontWeight: FontWeight.w700,
