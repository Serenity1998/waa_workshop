...
class SubCategoryBottomSheet extends GetView<CategoryController> {
  @override
        ...
        children: <Widget>[
          Padding(
            ...
            child: ListView(
              ...
              children: [
                Obx(() {
                  if (controller.category.value.subCategories!.isEmpty) {
                    return CircularLoadingWidget(height: 100);
                  }
                  return ExpansionTile(
                    title: Text("Sub categories".tr,
                        style: Get.textTheme.bodyMedium),
                    children: List.generate(
                        controller.category.value.subCategories!.length,
                        (index) {
                      var _category = controller.category.value.subCategories!
                          .elementAt(index);
                      return Obx(() {
                        return CheckboxListTile(
                          ...
                          onChanged: (value) {
                            controller.toggleSubCategory(value!, _category);
                          },
                          title: Text(
                            "${_category.name}",
          ...
          Container(
            ...
            child: Row(
              children: [
                Expanded(
                    child:
                        Text("Filter".tr, style: Get.textTheme.headlineSmall)),
                MaterialButton(
                  onPressed: () {
